...
using David_LabEx01.Authentication.JwtBearer;
...
namespace David_LabEx01.Controllers
{
    ...
    public class TokenAuthController : David_LabEx01ControllerBase
    {
        ...
        {
            return SimpleStringCipher.Instance.Encrypt(accessToken, David_LabEx01Consts.DefaultPassPhrase);
        }
    }
}
